...
def point_form(boxes):
    ...
    representation for comparison to point form ground truth config.
    Args:
...
def center_size(boxes):
    ...
    representation for comparison to center-size form ground truth config.
    Args:
...
def match(pos_thresh, neg_thresh, truths, priors, labels, crowd_boxes, loc_t, conf_t, idx_t, idx, loc_data):
    ...
    # waste any training config. In order to do that, find the max overlap anchor
