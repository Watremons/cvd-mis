...
zdj_CLASSES = ('person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
                'train', 'truck', 'boat', 'traffic light', 'fire hydrant',
                'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
                'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra', 'giraffe',
                'backpack', 'umbrella', 'handbag', 'tie', 'suitcase', 'frisbee',
                ...
                'mouse', 'remote', 'keyboard', 'cell phone', 'microwave', 'oven',
                'toaster', 'sink', 'refrigerator', 'book', 'clock', 'vase',
                'scissors', 'teddy bear', 'hair drier', 'toothbrush', 'vibrate_bar')
...
dataset_base = Config({
    ...
    'train_images': './config/coco/images/',
    'train_info':   'path_to_annotation_file',

    # Validation images and annotations.
    'valid_images': './config/coco/images/',
    'valid_info':   'path_to_annotation_file',

    # Whether or not to load GT. If this is False, run_image_detect.py quantitative evaluation won't work.
    'has_gt': True,
...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': '/media/ubuntu/7d17c4ae-0255-4946-a82e-1ebcb52957082/pengshun/datasets/vb_image/',
    'train_info':   '/media/ubuntu/7d17c4ae-0255-4946-a82e-1ebcb52957082/pengshun/datasets/vb_image-1.json',

    'valid_images': '/media/ubuntu/7d17c4ae-0255-4946-a82e-1ebcb52957082/pengshun/datasets/vb_image/',
    'valid_info':   '/media/ubuntu/7d17c4ae-0255-4946-a82e-1ebcb52957082/pengshun/datasets/vb_image-1.json',

    'has_gt': True,
    'class_names': zdj_CLASSES
})

coco2014_dataset = dataset_base.copy({
    'name': 'COCO 2014',

    'train_info': './config/coco/annotations/instances_train2014.json',
    'valid_info': './config/coco/annotations/instances_val2014.json',
...
coco2017_dataset = dataset_base.copy({
    ...
    'train_info': './config/coco/annotations/instances_train2017.json',
    'valid_info': './config/coco/annotations/instances_val2017.json',
...
coco2017_testdev_dataset = dataset_base.copy({
    ...
    'valid_info': './config/coco/annotations/image_info_test-dev2017.json',
    'has_gt': False,
...
pascal_sbd_dataset = dataset_base.copy({
    ...
    'train_images': './config/sbd/img',
    'valid_images': './config/sbd/img',

    'train_info': './config/sbd/pascal_sbd_train.json',
    'valid_info': './config/sbd/pascal_sbd_val.json',
...
backbone_base = Config({
    'name': 'Base Backbone',
    'path': 'path/to/pretrained/model_data',
    'type': object,
    'args': tuple(),
...
coco_base_config = Config({
    ...
    'mask_proto_grid_file': 'config/grid.npy',
    ...
    # SSD config augmentation parameters
    ...
    # Use the same model_data for each network head
    ...
    # Keeps track of the average number of examples for each class, and model_data the loss for that class accordingly.
...
def parse_args(argv=None):
    ...
    parser.set_defaults(display=False, resume=False, shuffle=False, detect=False, crop=True, mask_proto_debug=False, display_fps=False)
